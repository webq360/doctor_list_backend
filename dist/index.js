...
const hospital_ambulance_user_routes_1 = __importDefault(require("./routes/hospital_ambulance_user.routes"));
...
app.use('/api/v1/hospital-ambulance-users', hospital_ambulance_user_routes_1.default);
